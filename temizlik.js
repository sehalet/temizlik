...
function scavenge() {
    ...
    if (parseFloat(game_data.majorVersion) < 8.177) {
        var scavengeInfo = JSON.parse(<span class="math-inline">\('html'\)\.find\('script\:contains\("ScavengeScreen"\)'\)\.html\(\)\.match\(/\\\{\.\*\\\:\\\{\.\*\\\:\.\*\\\}\\\}/g\)\[0\]\);
var duration\_factor \= scavengeInfo\[1\]\.duration\_factor;
var duration\_exponent \= scavengeInfo\[1\]\.duration\_exponent;
var duration\_initial\_seconds \= scavengeInfo\[1\]\.duration\_initial\_seconds;
\}
else \{
var duration\_factor \= window\.ScavengeScreen\.village\.options\[1\]\.base\.duration\_factor;
var duration\_exponent \= window\.ScavengeScreen\.village\.options\[1\]\.base\.duration\_exponent;
var duration\_initial\_seconds \= window\.ScavengeScreen\.village\.options\[1\]\.base\.duration\_initial\_seconds;
\}
//var loot\_factor \= scavengeInfo\[1\]\.loot\_factor
function setScavTime\(\) \{
//check if duration is preset already
if \("ScavengeTime" in localStorage\)</0\> \{
minutes \= parseInt\(localStorage\.getItem\("ScavengeTime"\)\);
\} else \{
minutes \= 360; // Default 6 hours in minutes
\}
localStorage\.setItem\("ScavengeTime", minutes\);
\}
<0\>setScavTime\(\);
if \(</span>('button').length == 0) {
            ...
            <table class="scavengeTable" width="15%" style="border: 7px solid rgba(121,0,0,0.71); border-image-slice: 7 7 7 7; border-image-source: url(https://dsen.innogamescdn.com/asset/cf2959e7/graphic/border/frame-gold-red.png);">\
               <tbody>\
                  ...
                  <tr>\
                     ...
                     <td ID="runtime" align="center"><input type="text" ID="minutes" name="minutes" size="4" maxlength="5" align=left > minutes</td>\
         ...
         ';
            ...
            <table class="scavengeTable" width="15%" style="border: 7px solid rgba(121,0,0,0.71); border-image-slice: 7 7 7 7; border-image-source: url(https://dsen.innogamescdn.com/asset/cf2959e7/graphic/border/frame-gold-red.png);">\
             <tbody>\
                  ...
                  <tr>\
                     <th style="text-align:center" width="35"><a href="#" class="unit_link" data-unit="spear"><img src="https://dsen.innogamescdn.com/assetunit/unit_spear.png" title="Spear fighter" alt="" class=""></a></th>\
                     <th style="text-align:center" width="35"><a href="#" class="unit_link" data-unit="sword"><img src="https://dsen.innogamescdn.com/asset/cf2959e7/graphic/unit/unit_sword.png" title="Swordsman" alt="" class=""></a></th>\
                     <th style="text-align:center" width="35"><a href="#" class="unit_link" data-unit="axe"><img src="https://dsen.innogamescdn.com/asset/cf2959e7/graphic/unit/unit_axe.png" title="Axeman" alt="" class=""></a></th>\
                     <th style="text-align:center" width="35"><a href="#" class="unit_link" data-unit="light"><img src="https://dsen.innogamescdn.com/asset/cf2959e7/graphic/unit/unit_light.png" title="Light cavalry" alt="" class=""></a></th>\
                     <th style="text-align:center" width="35"><a href="#" class="unit_link" data-unit="heavy"><img src="https://dsen.innogamescdn.com/asset/cf2959e7/graphic/unit/unit_heavy.png" title="Heavy cavalry" alt="" class=""></a></th>\
        ...
        $.get('https://v.tylercamp.me/hc/scavengeSophie', function (json) {
            ...
            <span class="math-inline">\("\#countScript"\)\[0\]\.innerHTML \= count;
\}\);
document\.getElementById\("minutes"\)\.value</2\> \= minutes;
...
setScavTime\(\);
scavenge\(\);
document\.getElementById\("minutes"\)\.focus\(\);</2\>
\}\);
\}
if \(</span>(".scavengeTable")[0]) {
    ...
    $.each(checkboxValues, function (key, value) {
        <span class="math-inline">\("\#" \+ key\)\.prop\('checked', value\);
\}\);
if \(</span>(".scavengeTable").length) {
        ...
        heavyC = <span class="math-inline">\('\.units\-entry\-all\[data\-unit\=heavy\]'\)\.text\(\)\.match\(/\\\(\(\\d\+\)\\\)/\)\[1\];
if \(</span>('.units-entry-all[data-unit=archer]').text() != "") {
            archer = <span class="math-inline">\('\.units\-entry\-all\[data\-unit\=archer\]'\)\.text\(\)\.match\(/\\\(\(\\d\+\)\\\)/\)\[1\]
\} else archer \= 0;
if \(</span>('.units-entry-all[data-unit=marcher]').text() != "") {
...
\} else archer \= 0;
if \(</span>('.units-entry-all[data-unit=marcher]').text() != "") {
            marcher = <span class="math-inline">\('\.units\-entry\-all\[data\-unit\=marcher\]'\)\.text\(\)\.match\(/\\\(\(\\d\+\)\\\)/\)\[1\]
\} else marcher \= 0;
\}
